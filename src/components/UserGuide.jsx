export default function UserGuide() {
    ...
    return (
        <div id="user-guide" className="max-w-4xl mx-auto bg-[#242442] p-8 rounded-2xl shadow-xl mb-12 border border-blue-900/30">
            <h2 className="text-3xl font-bold text-center text-[#00d2ff] mb-8">
                Commands you should follow to use these features:
            </h2>

            <ul className="space-y-4 text-gray-300 text-lg mb-8 list-disc pl-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
                {apps.map((app) => (
                    <div key={app} className="bg-[#4a4a6a] hover:bg-[#5b5b85] p-4 rounded-lg text-center text-white font-medium transition-colors cursor-default shadow-md">
                        {app}
                    </div>
                ))}
            </div>

            <ul className="space-y-4 text-gray-300 text-lg mb-6 list-disc pl-6">
